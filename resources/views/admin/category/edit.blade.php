            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                @foreach($data as $v)
                                <option value="{{$v->cate_id}}"  @if($v->cate_id == $category->cate_pid) selected="selected" @endif>{{$v->cate_name}}</option>
                                    @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>描述：</th>
                        <td>
                            <textarea name="cate_desciption" >{{$category->cate_desciption}}</textarea>
                        </td>
                    </tr>
                    <tr>
