                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_id">
                                @foreach($data as $v)
                                <option value="{{$v->cate_id}}" @if($v->cate_id == $art->cate_id) selected="selected" @endif>{{$v->_cate_name}}</option>
                                    @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="/{{$art->art_thumb}}" id="atr_name_img" style="max-width: 350px;max-height:100px ;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <script id="editor" name="art_content"  type="text/plain" style="width:850px;height:300px;">{!!$art->art_content!!}</script>
                        <script>
