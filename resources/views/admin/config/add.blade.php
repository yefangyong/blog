            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio"  name="filed_type" value="input" checked="checked" onclick="showTr()">input　
                            <input type="radio"  name="filed_type" value="textarea" onclick="showTr()">textarea　
                            <input type="radio"  name="filed_type" value="radio" onclick="showTr()">radio　
                        </td>
                    </tr>
                    <tr class="filed_value">
                        <th><i class="require">*</i>类型值：</th>
                        <td>
                            <input type="text"  name="filed_value" checked="checked">
